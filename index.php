  ...
  <div class="container">
    <div class="row fullscreen align-items-center justify-content-between">
      <div class="col-lg-6 col-md-6 banner-left">
        ...
        <p><a href="https://ahmadhusairi20.github.io/situssejarahlinge12/" target="_blank" class="btn btn-default btn-lg">Lihat Detail</a></p>
      </div>
        ...
        <div class="row align-items-center">
          ...
          <script type="text/javascript">
            function initialize() {
              ...
              var mapOptions = {
                zoom: 15.2,
                center: new google.maps.LatLng(4.387116804738873, 97.20057435934397),
