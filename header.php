...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>SIG SITUS SEJARAH LINGE</title>

	<link rel="icon" href="admin/img/logo_ugp.png">
	...
	<header id="header">
		...
		<div class="container main-menu">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					<a href="index.php"><img src="admin/img/logo_ugp.png" width="60px" height="60px" alt="" title="" /></a>
				</div>
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						<li><a href="index.php">Home</a></li>
						<li><a href="data_situs.php">Situs Sejarah Linge</a></li>
						<li><a href="galery-situs.php">Galery</a></li>
